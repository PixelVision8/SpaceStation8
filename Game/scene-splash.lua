...
function SplashScene:Reset()
  ...
  -- Draw all the sprites in memory
  local total = 256
  ...
  for i = 1, 256 do
    ...
    local pos = CalculatePosition(id, cols)

    -- DrawSprite(id, pos.X * 8, pos.Y * 8, false, false, DrawMode.TilemapCache)
    

  end

  -- print("Empty Sprites", dump(emptySprites))
